...
class NestedResUNetAtt(nn.Module):
    def __init__(self, num_classes, input_channel=1, filters=[32, 64, 128, 256, 512]):
        ...
        self.residual_conv3 = ResidualConv(filters[2], filters[3], stride=2, padding=1)

        self.aspp_bridge = ASPP(filters[3], filters[4])

        self.attn1 = AttentionBlock(filters[2], filters[4], filters[4])
        self.upsample1 = Upsample_(2)
        self.up_residual_conv1 = ResidualConv(filters[4] + filters[2], filters[3], stride=1, padding=1)

        self.attn2 = AttentionBlock(filters[1], filters[3], filters[3])
        self.upsample2 = Upsample_(2)
        self.up_residual_conv2 = ResidualConv(filters[3] + filters[1], filters[2], stride=1, padding=1)
