...
from configs import get_CTranS_config
...
class UpBlock_attention(nn.Module):
    ...
    def forward(self, x, skip_x):
        ...
        print(f"skip_x_att: {skip_x_att.size()}")
...
model = UCTransNet(config, n_channels=3, n_classes=8, img_size=256, vis=False)
output = model(input)
