...
class Attention_org(nn.Module):
    ...
    def forward(self, emb1,emb2,emb3,emb4, emb_all):
        ...
        print(f'multi_head_Q1: {multi_head_Q1.size()}')
        print(f'multi_head_K: {multi_head_K.size()}')
        ...
        print(f'attention_probs1: {attention_probs1.size()}')
        ...
        print(f'context_layer1: {context_layer1.size()}')
...
class ChannelTransformer(nn.Module):
    ...
    def forward(self,en1, en2, en3, en4):
        ...
        print(en1.size(), en2.size(), en3.size(), en4.size())
        ...
        print(f'x2 - reconstructed emb2 = emb1: {x2.shape}')
        print(f'en1: {en1.size()}')
