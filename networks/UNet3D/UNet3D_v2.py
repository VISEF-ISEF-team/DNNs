...
class UNet3D(Module):
    ...
    def __init__(self, num_channels=1, num_classes=8, feat_channels=[64, 256, 256, 512, 1024], residual='conv'):
        ...
        self.one_conv = Conv3d(feat_channels[0], num_classes, kernel_size=1, stride=1, padding=0, bias=True)
